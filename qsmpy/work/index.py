...
def do_touzhu(item):
    ...
    html = wsp.get_text('https://qsm.qoo10.jp/GMKT.INC.Gsm.Web/ADPlus/ADPlusKeyword.aspx')
    ...
    # 获取投注第一行金额
    fetch_top_price_url = 'https://qsm.qoo10.jp/GMKT.INC.Gsm.Web/swe_ADPlusBizService.asmx/GetPlusItemKeywordGroup'
